...
export const BEARER_TOKENS = {
  ...
  rossella:
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2OTM3ZWM5MmQzMjJmNTAwMTUxMDc2YmQiLCJpYXQiOjE3NjUyNzI3MjIsImV4cCI6MTc2NjQ4MjMyMn0.vWHAJjdzIEvGFOp9KjcsS8-4bHPGkypGSgr1k5NYWfA",
  tanjin:
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2OTM3ZmViY2QzMjJmNTAwMTUxMDc2YzMiLCJpYXQiOjE3NjUyNzczNzIsImV4cCI6MTc2NjQ4Njk3Mn0.gkf18HzzZFjL0SQzSD6XG_AaguEkMiSNED1EjIHACMs", // TODO: Aggiungere token
};
