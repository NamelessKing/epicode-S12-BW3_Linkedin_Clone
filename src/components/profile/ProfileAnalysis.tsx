...
import { BsEyeFill, BsFillPeopleFill, BsBarChartLineFill, BsSearch, BsArrowRight  } from "react-icons/bs";
        ...
        <Card.Body>
          ...
          <Container>
            <Row className='row-cols-3'>
                ...
                <Col>
                    <p><BsBarChartLineFill /> 0 impressioni del post</p>
                    <p>Crea un post per aumentare l'interesse</p>
                    <p>Ultimi 7 giorni</p>
                </Col>
                <Col>
                    <p><BsSearch /> 3 comparse nel motore di ricerca</p>
